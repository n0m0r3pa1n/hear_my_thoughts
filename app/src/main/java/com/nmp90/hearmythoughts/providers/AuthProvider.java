...
public class AuthProvider {
    ...
    public User getUser() {
        //TODO: Remove
        //User teacher = new User("123"+ new Random().nextInt(), "Georgi Mirchev" + new Random().nextInt(), "", Role.TEACHER, "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VySWQiOiI1NTY4YmFlMTZkZDUzYzc0MjMyYjMwODEiLCJpYXQiOjE0MzI5MjY5NDV9.L8zWzpoNAmC-ygcWJdvBWNglzssRgv4Y9Y3qoJyr2yQ");
        User student = new User("123"+ new Random().nextInt(), "Georgi Mirchev" + new Random().nextInt(), "", Role.STUDENT, "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VySWQiOiI1NTY4YmFiYTZkZDUzYzc0MjMyYjMwODAiLCJpYXQiOjE0MzI5MjY5MDZ9.DEA2YVbC2hH4QABdX4r0ruuCwhnRvjXS1evTD7YF6kQ");
